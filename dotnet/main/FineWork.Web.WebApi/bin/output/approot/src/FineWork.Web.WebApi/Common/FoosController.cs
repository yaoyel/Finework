...
namespace FineWork.Web.WebApi.Common
{
    ...
    {
        public FoosController(ISessionScopeFactory sessionScopeFactory)
        ...
        {
            var s = $"Has AutoTransactionScope : {this.AutoTransactionScope != null} , Has AutoSessionScope : {this.AutoSessionScope != null}";
            return s;
        }
